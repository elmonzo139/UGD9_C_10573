package com.example.ugd89_c_10573_project2
...
import com.example.ugd89_c_10573_project2.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun createNotificationChannel(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            val name = "UGD89_C_10762_PROJECT2"
    ...
    private fun sendNotification2(){
        val builder = NotificationCompat.Builder(this, CHANNEL_ID_2)
            ...
            .setContentTitle("MODUL89_C_10762_PROJECT2")
